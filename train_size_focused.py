#!/usr/bin/env python3
"""
Enhanced training script specifically focused on size extraction
"""
...
BATCH_SIZE = 1
EPOCHS = 8  # Increased epochs for better size extraction
LR = 1e-4   # Lower learning rate for fine-tuning
MAX_LENGTH = 1024

print("=" * 60)
print("ENHANCED SIZE EXTRACTION MODEL TRAINING")
print("=" * 60)
...
# Enhanced PEFT LoRA config for size extraction
peft_config = LoraConfig(
    r=32,  # Increased rank for better size extraction
...
# Enhanced training arguments for size extraction
training_args = TrainingArguments(
    ...
    warmup_ratio=0.05,  # Increased warmup
...
print("=" * 60)
print("STARTING SIZE EXTRACTION TRAINING...")
print("=" * 60)
...
print("=" * 60)
print("SIZE EXTRACTION TRAINING COMPLETED!")
print("=" * 60)
print(f"Model saved to: {OUTPUT_DIR}")
print("The model is now trained specifically for better size extraction!")
print("Test it with: python test_size_extraction.py")
print("=" * 60)
